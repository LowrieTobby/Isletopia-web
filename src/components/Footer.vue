    ...
    <footer>
      <div class="container">
        <div class="footer-links col-12">
          <div class="row">
            <div class="col-lg-4">
              <div class="foo-logo-wrapper d-flex justify-content-md-center">
                <a href="/">
                  <img
                    class
              ...
              <div class="row">
                <div class="col-md-4 col-sm-6">
                  <ul>
                    ...
                    <li>
                      <a href="https://afdian.net/@molean">
                        赞助我们
                ...
                <div class="col-md-4 col-sm-6">
                  <ul>
                    ...
                    <li>
                      <a href="https://www.mcbbs.net/thread-949407-1-1.html">
                        MCBBS宣传贴
                        <font-awesome-icon :icon="['fas', 'external-link-alt']" size="xs" />
                      </a>
                    </li>
